  ...
  return (
    <div className="App">
      ...
      <div className='NavBar'>
        ...
        <a href="/">
            <button data-tooltip-id="btn2" data-tooltip-content="A ratio of cases per death" data-tooltip-place="bottom" className='btn-current' onClick={() => window.location.reload(true)}>Case fatality ratio</button>
        </a>
        <a href="/casesper1000">
            <button data-tooltip-id="btn2" data-tooltip-content="Number of cases per 1000 people" data-tooltip-place="bottom" className='btn' onClick={() => window.location.reload(true)}>Cases per 1000 people</button>
            </a>
        </div>
